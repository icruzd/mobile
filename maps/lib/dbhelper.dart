...
class DbHelper {
  ...
  Future insertMockData() async {
    db = await openDb();
    await db.execute(
        'INSERT INTO places VALUES (4, "Beautiful park", 41.9294115, 12.5380785, "")');
    await db.execute(
        'INSERT INTO places VALUES (5, "Best Pizza", 41.9294115, 12.5268947, "")');
    await db.execute(
        'INSERT INTO places VALUES (6, "The best icecream", 41.9349061, 12.5339831, "")');
